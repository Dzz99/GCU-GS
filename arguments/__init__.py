...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.single_view_weight = 0.01
        self.single_view_weight_from_iter = 2000
        ...
        self.multi_view_weight_from_iter = 2000
        ...
        self.max_abs_split_points = 2000_000
        self.max_all_points = 4000_000
        self.exposure_compensation = False
        self.random_background = False
        self.geom_densify = False
        self.start_sample_pseudo = 2000
        self.start_single_view = 2000
        self.k_search = 16
        self.topk = 0.2
        self.max_angle_deg = 15
